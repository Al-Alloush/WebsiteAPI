...
select * from dbo.Blogs where UserId = '8f498c2d-e949-49e9-afc1-baf9e1626fbd'
select * from dbo.BlogComments where id = '3838'
select * from dbo.BlogLike where UserId = '433ab5fd-daf6-4e08-83b3-12fab99fccfd'

select * from dbo.AspNetUsers where id = 'ecc59543-c960-4dad-836f-55a8b14781e1'

select * from dbo.UserSelectedLanguages where UserId = 'cfa33656-b47e-4b7b-b559-0acc4bea6114'
...
select * from dbo.Blogs where Id = '2001'
